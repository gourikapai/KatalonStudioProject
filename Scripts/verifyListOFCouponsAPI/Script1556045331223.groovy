...
WS.verifyElementPropertyValue(response, 'data[0].name', 'CouponWith34OFF')

WS.verifyElementPropertyValue(response, 'data[5].id', '75OFF')

WS.verifyElementsCount(response, 'data.id', 10)
